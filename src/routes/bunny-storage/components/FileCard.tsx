      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 px-3 py-2 bg-orange-500 hover:bg-orange-600 disabled:bg-orange-500/50 text-white rounded-lg flex items-center justify-center gap-2 transition-colors text-sm font-medium"
